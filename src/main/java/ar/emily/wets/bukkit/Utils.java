...
public class Utils {
    ...
    public static String legacySerializerAnyCase(String subject) {
        ...
        String serializedText = LegacyComponentSerializer.legacySection()
                .serialize(LegacyComponentSerializer.legacyAmpersand().deserialize(subject));
